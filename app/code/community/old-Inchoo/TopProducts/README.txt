...
***********************************************
 ...
 3. Added pagination to top products view
...
10. Added Inchoo's template file for Top Products listing on separate page, as this way is more stable with your
    modifications on site (if any)
11. Fixed ACL permissions - separated Top Products Data permission (under Catalog menu) and Top Products
...
13. Added breadcrumbs for Top Products page
...
***********************************************
 1. Make a backup of both files and database
 2. Open "app/etc/modules/Inchoo_TopProducts.xml" and change "<active>true</active>" to "<active>false</active>"
 3. Test if anything on site got broken (although it shouldn't)
 4. Remove "TopProducts" directory from "app/code/community/Inchoo" if previous step went well
 5. Remove "Inchoo_TopProducts.xml" from "app/etc/modules" directory
