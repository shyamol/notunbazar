...
class Abac_Classified_Block_Form_Edit extends Mage_Customer_Block_Form_Edit {
...
/*    public function getGenderHtmlSelect($defValue=null, $name='gender', $id='gender', $title='Gender')
    {
		...
		if (Mage::app()->useCache('config') && $cache = Mage::app()->loadCache($cacheKey)) {
		    ...
		    $options = Mage::getModel('classified/gendertype')->toOptionArray();
   ...
   public function getAvatar($customerId, $w = 150, $h = 150)
    {
		...
		if ( $name != '' ) {
			$resize_object = Mage::getModel('classified/resizeimage');
