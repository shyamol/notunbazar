 ...
 */
class Inchoo_PendingProducts_Adminhtml_PendingController extends Mage_Adminhtml_Controller_Action {
    ...
    public function indexAction() {
        ...
        $this->loadLayout()->_setActiveMenu('catalog/pendingproduct');

       // $this->_addContent($this->getLayout()->createBlock('pendingproducts/adminhtml_edit'));

       // $this->renderLayout();

        $this->_title($this->__('Sales'))->_title($this->__('pendingproducts'));
        //$this->loadLayout();
       // $this->_setActiveMenu('sales/sales');
        $this->_addContent($this->getLayout()->createBlock('inchoo_pendingproducts/adminhtml_edit'));
        $this->renderLayout();
    }
    ...
    public function gridAction() {
        ...
        $this->getResponse()->setBody(
                $this->getLayout()->createBlock('inchoo_pendingproducts/adminhtml_edit_grid')->toHtml()
        );
    ...
    //             $product->setData('status', $featured_products[$product->getEntityId()]);
    ...
    public function exportCsvAction() {
        ...
        $content = $this->getLayout()->createBlock('pendingproducts/adminhtml_edit_grid')
                ->getCsvFile();
