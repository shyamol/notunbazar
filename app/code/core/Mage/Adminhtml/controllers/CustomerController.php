...
class Mage_Adminhtml_CustomerController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction()
    {
        ...
        // echo $this->getRequest()->getPost('nickname');
        // exit();
        ...
        // exit();
            $uldURLCollection = Mage::getModel('core/url_rewrite')->getResourceCollection();
                            $uldURLCollection->getSelect()
                                ->where('id_path=?', 'classified/'.strtolower($formData['nickname']));
                    ...
                    $modelURLRewrite->setIdPath('classified/'.strtolower($formData['nickname']))
                                ->setTargetPath('classified/profile/view/nickname/'.$formData['nickname'])
                                ->setOptions('')
                                ->setDescription(null)
                                ->setRequestPath($formData['nickname']);
