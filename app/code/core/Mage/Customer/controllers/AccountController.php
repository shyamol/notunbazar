    ...
    public function createPostAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($this->getRequest()->getParam('nickname')) {
                $customer->setNickname($this->getRequest()->getParam('nickname'));
            }
            //$errors = array();
            //$fields = $this->getRequest()->getParam('nickname');
            if (($error = $this->validateProfileFields('nickname', $this->getRequest()->getParam('nickname'), $customer->getId())) !== true) {
                        $errors[] = $error;
                    } 
                    else {
             ...
             $uldURLCollection = Mage::getModel('core/url_rewrite')->getResourceCollection();
                            $uldURLCollection->getSelect()
                                ->where('id_path=?', 'classified/'.strtolower($this->getRequest()->getParam('nickname')));
                    ...
                    $modelURLRewrite->setIdPath('classified/'.strtolower($this->getRequest()->getParam('nickname')))
                                ->setTargetPath('classified/profile/view/nickname/'.$this->getRequest()->getParam('nickname'))
                                ->setOptions('')
                                ->setDescription(null)
                                ->setRequestPath($this->getRequest()->getParam('nickname'));

                    $modelURLRewrite->save();
                    $customer->setData('nickname', $this->getRequest()->getParam('nickname'));
                }
            /**
