...
$.fn.jMyCarousel = function(o) {   
    o = $.extend({
        ...
        speed: 300,				// speed in ms of the animation.
    ...
    return this.each(function() {                           // Returns the element collection. Chainable.   
        ...
        li.css("overflow", "hidden")                        // If the list item size is bigger than required
            ...
            .children().css("overflow", "");          // If the item within li overflows its size, hide'em
		...
		if(defaultBtn){
			...
			if(o.vertical){
				...
				prev.css({'left':'0px', 'top':  '55px'});
	        	next.css({'right':'0px', 'top':  '55px'});
