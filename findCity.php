...
$query = "SELECT t1.region_id as id, t2.value as regionname FROM " . $table_prefix . "country_region as t1 INNER JOIN " . $table_prefix . "eav_attribute_option_value as t2 where t1.country_id = " . $countryId . " and  t1.state_id = " . $stateId . " and t2.store_id = 0 and t1.region_id = t2.option_id ORDER BY regionname ASC";
